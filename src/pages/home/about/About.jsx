   ...
   <div className='w-full'>
    ...
    <div className='w-full flex items-center gap-16 justify-between flex-wrap'> 
      ...
      <div className='w-[90%] md:space-y-6 space-y-4'>
        <button className='md:w-1/2 w-full px-6 md:py-5 py-3 text-lg text-neutral-50 fnt-medium rounded-xl bg-neutral-50/20 border-2 border-neutral-50/60 hover:bg-transparent hover:text-neutral-50 hover:border-neutral-50 flex items-center justify-between ease-in-out duration-300'>
        Appointment
